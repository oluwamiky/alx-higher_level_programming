...
class TestSquare_instant(unittest.TestCase):
    """Unittests for testing instant of the Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Unittests for testing size initial of the Square class."""
...
class TestSquare_x(unittest.TestCase):
    """Unittests for testing initial of Square x attribute."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests for testing initial of Square y attribute."""
...
class TestSquare_order_of_initial(unittest.TestCase):
    """Unittests for testing order of Square attribute initial."""
